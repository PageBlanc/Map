...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/18 18:48:00 by axdubois          #+#    #+#             */
...
void PerlinNoise::shuffle(std::vector<int>& vec, unsigned int seed)
{
    srand(seed);
    for (int i = 255; i > 0; i--) {
        int j = rand() % (i + 1);
