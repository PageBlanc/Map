...
// node_modules/stats/lib/uglify/parser.js
var require_parser = __commonJS({
  "node_modules/stats/lib/uglify/parser.js"(exports) {
...
// node_modules/stats/lib/parser.js
var require_parser2 = __commonJS({
  "node_modules/stats/lib/parser.js"(exports, module) {
    var parse = require_parser().parse;
    var sys = require_util();
    module.exports = function(str, options) {
      var options = options || {}, stats = {
        loc: str.split("\n").length,
      ...
      visit["var"] = visit["const"] = function(node) {
        node[1].forEach(function(node2) {
          if (node2[1]) ++stats.assignments;
          visit(node2[1]);
        });
        ++stats.statements;
      };
...
// node_modules/stats/lib/find.js
var require_find = __commonJS({
  "node_modules/stats/lib/find.js"(exports, module) {
    var fs = require_fs();
    ...
    module.exports = function(paths, fn) {
      ...
      function find(path2) {
        fs.stat(path2, function(err, stat) {
          ...
          if (stat.isFile() && isJavaScript(path2)) {
            ret.push(path2);
            --pending || fn(null, ret);
          } else {
            fs.readdir(path2, function(err2, files) {
              ...
              files.forEach(function(file) {
                file = join(path2, file);
                if (isJavaScript(file)) {
                  ret.push(file);
                } else {
                  ++pending;
                  fs.stat(file, function(err3, stat2) {
                    if (err3) return;
                    if (!stat2.isDirectory()) return --pending || fn(null, ret);
                    find(file);
                  });
                }
              });
...
// node_modules/stats/lib/formats/json.js
var require_json = __commonJS({
  "node_modules/stats/lib/formats/json.js"(exports, module) {
...
// node_modules/stats/lib/formats/text.js
var require_text = __commonJS({
  "node_modules/stats/lib/formats/text.js"(exports, module) {
    exports = module.exports = function(files) {
      Object.keys(files).forEach(function(file) {
        var stats = files[file];
        console.log("\n  \x1B[90m%s:\x1B[0m", file);
        Object.keys(stats).forEach(function(name) {
          var val = stats[name];
          if (exports[name]) val = exports[name](val);
          console.log("    \x1B[90m%s: \x1B[36m%s\x1B[0m", name, val);
        });
      });
      console.log();
    };
    exports.bytes = exports.stringBytes = function(n) {
...
// node_modules/stats/lib/formats/index.js
var require_formats = __commonJS({
  "node_modules/stats/lib/formats/index.js"(exports) {
    exports.json = require_json();
    exports.text = require_text();
  }
});

// node_modules/stats/lib/stats.js
var require_stats = __commonJS({
  "node_modules/stats/lib/stats.js"(exports) {
    exports.version = "0.0.6";
    exports.parse = require_parser2();
    exports.find = require_find();
    exports.formats = require_formats();
  }
});

// node_modules/stats/index.js
var require_stats2 = __commonJS({
  "node_modules/stats/index.js"(exports, module) {
    module.exports = require_stats();
  }
});
export default require_stats2();
