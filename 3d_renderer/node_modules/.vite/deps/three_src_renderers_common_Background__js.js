...
var AfterImageNode = class extends TempNode_default {
  constructor(textureNode, damp2 = 0.96) {
    super(textureNode);
    this.textureNode = textureNode;
    this.textureNodeOld = texture();
    this.damp = uniform(damp2);
...
var afterImage = (node, damp2) => nodeObject(new AfterImageNode(nodeObject(node).toTexture(), damp2));
...
var BloomNode = class extends TempNode_default {
  ...
  setup(builder) {
    const luminosityHighPass = tslFn(() => {
      ...
      const alpha = smoothstep2(this.threshold, this.threshold.add(this.smoothWidth), v);
